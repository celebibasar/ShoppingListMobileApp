...
namespace ShoppingListMobileApp
{
    public partial class VerificationPageView : ContentPage
    {
        ...
        private readonly int _duration = 120;
        private double _progress;
        private CancellationTokenSource _cancellationTokenSource = new();
        private VerificationPageViewModel _verify = new();
        ...
        private async void UpdateArc()
        {
            while (!_cancellationTokenSource.Token.IsCancellationRequested)
            {
                ...
                {
                    _cancellationTokenSource.Cancel();
                    // sayfaya girip çıkıldığında arkada çalışıyor.
                    //_ = DisplayAlert("Verification", "Verilen süre doldu.", "OK");
        ...
        {
            if (_verify.IsVerificationCodeWrong == true)
            {
                DisplayAlert("Verification", "Girilen kod hatalı.", "OK");
            }
        }
    }
